...
http.createServer(function (req, res) {
    ...
    res.write('<form action="fileupload" method="post" enctype="multipart/fomr-data">');
...
// Include the Formidable module to be able to parse the uploaded file once 
...
http.createServer(function (req, res) {
    ...
    res.writeHead(200, { 'Consten-Type': 'text/html' });
    res.write('<form action="fileupload" methdo="post" enctype="multipart/form-data">');
    res.write('<input type="file" name="filetoupload"><br>');
    res.write('<input type="submit">');
    res.write('</form>');
    return res.end();
...
// temporary folder.
// The path to this directory can be found in the "files" object, passed
// as the third argument in the parse() method's callback function.
